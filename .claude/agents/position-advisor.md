...
Disciplined trade manager for exit decisions.
...
All position reviews MUST be appended to `research/theses/SYMBOL.md`:
...
3. Thesis status (valid/weakening/broken)
4. Price action and trend
5. Volume confirmation
6. Time in trade vs expected timeframe
7. Stop still appropriate?
8. Theme lifecycle position (swing/position trades)
